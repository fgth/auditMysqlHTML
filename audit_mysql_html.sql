...
-- ******************
-- NOTE - A RESOUDRE - A ETUDIER : Y a-t-il des stats spécifiques à chaque bases par rapport aux stats globales du serveur ?
...
-- TODO : ajouter des icônes/infobulles d'informations dans les tableaux (=> variable avec base64 image ?)
--  dependant: TODO : Repérer et coloriser les modifications de valeurs de caches entre 2 audits
--  dépendant: TODO : repérer changements de paramètres init entre 2 audits
...
-- TODO : pour mysq >= 5.6, ajouter liste des indexes inutilisés (performance_schema.table_io_waits_summary_by_index_usage)
...
-- Section REQUETES : si uptime < 1 jour, le nombre de jointure sans index par jour est délirant (ex : "38 (22959.44/jour)")
--    02/18 requête patchée, à valider à l'usage
-- Section InnoDB : si InnoDB non activé (variable ignore_builtin_innodb n'existe pas pour engine "InnoDB"), les requêtes renvoient "empty" et n'affichent donc rien.
--
-- *********** USAGE ****************
